export type P_ALTER_TABLE_ACTION = 'addColumn' | 'addColumns' | 'addIndex' | 'addPrimaryKey' | 'addUniqueKey' | 'addFulltextIndex' | 'addSpatialIndex' | 'addForeignKey' | 'setDefaultColumnValue' | 'dropDefaultColumnValue' | 'changeColumn' | 'dropColumn' | 'dropIndex' | 'dropPrimaryKey' | 'dropForeignKey' | 'renameIndex' | 'rename';
