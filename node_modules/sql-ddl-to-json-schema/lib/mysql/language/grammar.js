...
const grammar = {
    ...
    ParserRules: [
        ...
        { "name": "O_INTEGER_DATATYPE$subexpression$1", "symbols": [(lexer.has("K_INT") ? { type: "K_INT" } : K_INT)], "postprocess": d => { return { datatype: d[0].value }; } },
        { "name": "O_INTEGER_DATATYPE$subexpression$1", "symbols": [(lexer.has("K_INTEGER") ? { type: "K_INTEGER" } : K_INTEGER)], "postprocess": d => { return { datatype: d[0].value }; } },
        { "name": "O_INTEGER_DATATYPE$subexpression$1", "symbols": [(lexer.has("K_TINYINT") ? { type: "K_TINYINT" } : K_TINYINT)], "postprocess": d => { return { datatype: d[0].value }; } },
        { "name": "O_INTEGER_DATATYPE$subexpression$1", "symbols": [(lexer.has("K_SMALLINT") ? { type: "K_SMALLINT" } : K_SMALLINT)], "postprocess": d => { return { datatype: d[0].value }; } },
        { "name": "O_INTEGER_DATATYPE$subexpression$1", "symbols": [(lexer.has("K_MEDIUMINT") ? { type: "K_MEDIUMINT" } : K_MEDIUMINT)], "postprocess": d => { return { datatype: d[0].value }; } },
        { "name": "O_INTEGER_DATATYPE$subexpression$1", "symbols": [(lexer.has("K_BIGINT") ? { type: "K_BIGINT" } : K_BIGINT)], "postprocess": d => { return { datatype: d[0].value }; } },
