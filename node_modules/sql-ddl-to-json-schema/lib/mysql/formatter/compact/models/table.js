...
class Table {
    ...
    static fromCommonDef(json, database) {
        if (json.id === 'P_CREATE_TABLE_COMMON') {
            ...
            createDefinitions.forEach((createDefinition) => {
                 ...
                 */
                if ((0, utils_1.isDefined)(createDefinition.def.column)) {
                    const column = column_1.Column.fromDef(createDefinition);
                    table.addColumn(column);
                }
                else if ((0, utils_1.isDefined)(createDefinition.def.fulltextIndex)) {
                    /**
                ...
                else if ((0, utils_1.isDefined)(createDefinition.def.spatialIndex)) {
                    /**
                ...
                else if ((0, utils_1.isDefined)(createDefinition.def.foreignKey)) {
                    /**
                ...
                else if ((0, utils_1.isDefined)(createDefinition.def.uniqueKey)) {
                    /**
                ...
                else if ((0, utils_1.isDefined)(createDefinition.def.primaryKey)) {
                    /**
                ...
                else if ((0, utils_1.isDefined)(createDefinition.def.index)) {
                    /**
    ...
    toJSON() {
        ...
        if ((0, utils_1.isDefined)(this.primaryKey)) {
            json.primaryKey = this.primaryKey.toJSON();
        }
        if ((0, utils_1.isDefined)(this.foreignKeys) && this.foreignKeys.length) {
            json.foreignKeys = this.foreignKeys.map((k) => k.toJSON());
        }
        if ((0, utils_1.isDefined)(this.uniqueKeys) && this.uniqueKeys.length) {
            json.uniqueKeys = this.uniqueKeys.map((k) => k.toJSON());
        }
        if ((0, utils_1.isDefined)(this.indexes) && this.indexes.length) {
            json.indexes = this.indexes.map((i) => i.toJSON());
        }
        if ((0, utils_1.isDefined)(this.spatialIndexes) && this.spatialIndexes.length) {
            json.spatialIndexes = this.spatialIndexes.map((i) => i.toJSON());
        }
        if ((0, utils_1.isDefined)(this.fulltextIndexes) && this.fulltextIndexes.length) {
    ...
    addColumn(column, position) {
        ...
        if (!(0, utils_1.isArray)(this.columns)) {
            this.columns = [];
        }
        if (!(0, utils_1.isDefined)(position)) {
    ...
    moveColumn(column, position) {
        if (!(0, utils_1.isDefined)(this.columns) || !(0, utils_1.isDefined)(position)) {
            return false;
        }
    ...
    dropColumn(column) {
         ...
         */
        const hasReference = this.getTables().some((t) => (t.foreignKeys ?? []).some((k) => k.referencesTableAndColumn(this, column)));
        if (hasReference) {
            return;
        }
        if (!(0, utils_1.isDefined)(this.columns)) {
            return;
        }
        /**
    ...
    dropIndexByInstance(index) {
        ...
        if (!(0, utils_1.isDefined)(type) || !(0, utils_1.isDefined)(this[type])) {
            return;
        }
    ...
    dropForeignKey(foreignKey) {
        if (!(0, utils_1.isDefined)(this.foreignKeys)) {
            return;
        }
    ...
    getIndexTypeByInstance(index) {
        ...
        const type = props.find((prop) => (this[prop] ?? []).some((i) => i === index));
        return type;
    }
    /**
     * Get which index array is storing a given index.
    ...
    getIndexTypeByName(name) {
        ...
        const type = props.find((prop) => (this[prop] ?? []).some((i) => i.name === name));
        return type;
    }
    /**
     * Get column by name.
    ...
    pushFulltextIndex(fulltextIndex) {
        ...
        if (!(0, utils_1.isDefined)(this.fulltextIndexes)) {
    ...
    pushSpatialIndex(spatialIndex) {
        ...
        if (!(0, utils_1.isDefined)(this.spatialIndexes)) {
            this.spatialIndexes = [];
        }
    ...
    pushUniqueKey(uniqueKey) {
        ...
        if (!(0, utils_1.isDefined)(this.uniqueKeys)) {
            this.uniqueKeys = [];
        }
    ...
    pushIndex(index) {
        ...
        if (!(0, utils_1.isDefined)(this.indexes)) {
            this.indexes = [];
        }
