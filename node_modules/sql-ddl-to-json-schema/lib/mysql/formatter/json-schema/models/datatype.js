...
class Datatype {
    ...
    static fromCompactJson(json) {
        ...
        if ((0, utils_1.isDefined)(json.decimals)) {
            datatype.decimals = json.decimals;
        }
        if ((0, utils_1.isDefined)(json.digits)) {
            datatype.digits = json.digits;
        }
        if ((0, utils_1.isDefined)(json.fractional)) {
            datatype.fractional = json.fractional;
        }
        if ((0, utils_1.isDefined)(json.length)) {
            datatype.length = json.length;
        }
        if ((0, utils_1.isDefined)(json.values)) {
            datatype.values = json.values;
        }
        if ((0, utils_1.isDefined)(json.displayWidth)) {
            datatype.displayWidth = json.displayWidth;
        }
        return datatype;
    }
    static isIntegerDataType(type) {
    ...
    toJSON() {
        ...
        if (this.datatype === 'tinyint') {
            if (this.isUnsigned) {
                json.minimum = constants_1.TINYINT_UNSIGNED_MIN;
                json.maximum = constants_1.TINYINT_UNSIGNED_MAX;
            }
            else {
                json.minimum = constants_1.TINYINT_SIGNED_MIN;
                json.maximum = constants_1.TINYINT_SIGNED_MAX;
            }
        }
        else if (this.datatype === 'smallint') {
            if (this.isUnsigned) {
                json.minimum = constants_1.SMALLINT_UNSIGNED_MIN;
                json.maximum = constants_1.SMALLINT_UNSIGNED_MAX;
            }
            else {
                json.minimum = constants_1.SMALLINT_SIGNED_MIN;
                json.maximum = constants_1.SMALLINT_SIGNED_MAX;
            }
        }
        else if (this.datatype === 'mediumint') {
            if (this.isUnsigned) {
                json.minimum = constants_1.MEDIUMINT_UNSIGNED_MIN;
                json.maximum = constants_1.MEDIUMINT_UNSIGNED_MAX;
            }
            else {
                json.minimum = constants_1.MEDIUMINT_SIGNED_MIN;
                json.maximum = constants_1.MEDIUMINT_SIGNED_MAX;
            }
        }
        else if (this.datatype === 'int') {
            if (this.isUnsigned) {
                json.minimum = constants_1.INT_UNSIGNED_MIN;
                json.maximum = constants_1.INT_UNSIGNED_MAX;
            }
            else {
                json.minimum = constants_1.INT_SIGNED_MIN;
                json.maximum = constants_1.INT_SIGNED_MAX;
            }
        }
        else if (this.datatype === 'bigint') {
            if (this.isUnsigned) {
                json.minimum = constants_1.BIGINT_UNSIGNED_MIN_1;
                json.maximum = constants_1.BIGINT_UNSIGNED_MAX_1;
            }
            else {
                json.minimum = constants_1.BIGINT_SIGNED_MIN_1;
                json.maximum = constants_1.BIGINT_SIGNED_MAX_1;
            }
        }
